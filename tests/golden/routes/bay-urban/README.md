...
over **USGS 3DEP terrain** and **8,480 Overture building footprints**. This is the route
...
This one proves the pipeline **survives contact with real data** — 8,480 footprints of
...
| Buildings | Overture `2026-08-19.0`, via duckdb over S3 | real, 7,838 of 8,480 with a height |
